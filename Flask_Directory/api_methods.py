...
def request_best_sellers(date, name):
    ...
    json_functions.save_to_file(best_sellers_response, f"{abs_path}/best_sellers.json")
...
def request_book_reviews_isbn(isbn):
    ...
    abs_path = os.environ['ABS_PATH']
    json_functions.save_to_file(reviews_isbn_response, f"{abs_path}/isbn_reviews.json")
...
def request_book_reviews_title(title):
    ...
    abs_path = os.environ['ABS_PATH']
    json_functions.save_to_file(reviews_title_response, f"{abs_path}/title_reviews.json")
...
def request_book_reviews_author(author):
    ...
    abs_path = os.environ['ABS_PATH']
    json_functions.save_to_file(reviews_author_response, f"{abs_path}/author_reviews.json")
